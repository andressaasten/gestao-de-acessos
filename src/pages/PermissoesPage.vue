      ...
      <template v-slot:body-cell-docs="props">
        <q-td :props="props">
          <div v-for="perm in props.row.docs" :key="perm.docId" class="q-mb-md">
            ...
            <div class="q-mt-xs">
              <q-chip v-if="perm.perms.includes('read')" color="primary" text-color="white" size="sm">Leitura</q-chip>
              <q-chip v-if="perm.perms.includes('comment')" color="orange" text-color="white" size="sm">Comentar</q-chip>
              <q-chip v-if="perm.perms.includes('edit')" color="teal" text-color="white" size="sm">Editar</q-chip>
            </div>
